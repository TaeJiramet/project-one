        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    @auth
                        <a href="{{ route('admin.dashboard') }}" class="btn btn-sm btn-outline-light me-2">Dashboard</a>
                        <form id="logout-form" method="POST" action="{{ route('logout') }}" style="display: inline;">
                            @csrf
                        </form>
                        <a href="#" class="btn btn-sm btn-outline-light" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                    @else
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li style="margin-bottom: 10px; display: flex; align-items: flex-start;">
                            ...
                            <span>อาคารปฏิบัติการคอมพิวเตอร์ ชั้น 4 ภาควิชาวิศวกรรมซอฟต์แวร์ คณะวิทยาศาสตร์และเทคโนโลยี มหาวิทยาลัยราชภัฏนครปฐม ถนนมาลัยแมน อำเภอเมือง จังหวัดนครปฐม 73000</span>
                        </li>
                        <li style="margin-bottom: 10px; display: flex; align-items: flex-start;">
                            <span style="margin-right: 10px;">📞</span>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p style="margin: 0; font-size: 0.9rem; color: rgba(255,255,255,0.7);">
                        &copy; 2568 คณะวิทยาศาสตร์และเทคโนโลยี มหาวิทยาลัยราชภัฏนครปฐม. สงวนลิขสิทธิ์.
                    </p>
