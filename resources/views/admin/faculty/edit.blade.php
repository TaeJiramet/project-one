...
<form method="POST" action="{{ route('admin.faculty.update', $facultyMember->faculty_id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                @if($facultyMember->file_path)
                    <div class="mt-2">
                        ...
                        <div>
                            <img src="{{ asset('storage/'.$facultyMember->file_path) }}" alt="Current image" style="max-width: 100px; max-height: 100px; border-radius: 8px; object-fit: cover;">
                        </div>
                    </div>
                @endif
            </div>
